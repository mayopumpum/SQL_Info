...
Cкрипт *part1.sql*, создающий базу данных и все таблицы, описанные выше. 

Также в скрипте есть процедуры, позволяющие импортировать и экспортировать данные для каждой таблицы из файла/в файл с расширением *.csv*. \
В качестве параметра каждой процедуры указывается разделитель *csv* файла.

## Part 2. Изменение данных

скрипт *part2.sql*,помимо описанного ниже, есть тестовые запросы/вызовы для каждого пункта.
